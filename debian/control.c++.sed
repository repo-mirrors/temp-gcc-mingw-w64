s/@@PACKAGE@@/g++/g
s/@@LANGUAGE@@/C++/g
s/@@DEPENDS32@@/gcc-mingw-w64-i686 (= ${binary:Version}), libstdc++-4.8-dev (>= ${local:Version})/g
s/@@DEPENDS64@@/gcc-mingw-w64-x86-64 (= ${binary:Version}), libstdc++-4.8-dev (>= ${local:Version})/g
s/@@RECOMMENDS@@//g
